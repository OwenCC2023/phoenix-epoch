...
## Systems built (as of 2026-04-04)
...
**Key constants:**
```
backend/economy/literacy_constants.py  — S-curve, policy penalties, happiness amplifier, migration sensitivity
backend/economy/research_constants.py — unlock costs per sector, literacy-research multiplier
```
...
**Building changes in this system:**
- Madrasa: `literacy_bonus` reduced from 0.10 → 0.06
- Trading Post: added `literacy_bonus: 0.02`
...
| App | Migrations |
|-----|-----------|
| provinces | 0001_initial, 0002_add_province_designation, 0003_capital_designation_and_pop_default, 0004_*(military)*, 0005_zone_adjacency_and_travel, 0006_add_local_security, 0007_add_province_happiness, 0008_add_province_literacy |
