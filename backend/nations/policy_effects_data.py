...
POLICY_CATEGORIES = {
    ...
    # --- Wealth & Taxation System (System 18) — 4 parallel tax policy axes -----
    # Structure-only: effects dict intentionally empty; per-rank tax structure
    # is resolved at collection time via nations.tax_policy.
    'income_tax': {
        "name": 'Income Tax',
        "default_level": 1,
        "levels": [
