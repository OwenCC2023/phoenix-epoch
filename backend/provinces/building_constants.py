...
BUILDING_TYPES = {
    ...
    "workshop": {
        ...
        "base_construction_cost": {"materials": 1000, "wealth": 500},
    ...
    "arms_factory": {
        ...
        "base_construction_cost": {"materials": 2000, "wealth": 1000, "manpower": 500},
    ...
    "heavy_forge": {
        ...
        "base_construction_cost": {"materials": 1800, "wealth": 900},
        "base_construction_turns": 12,
        "base_effects": {},
    },
    "industrial_complex": {
        ...
        "base_construction_cost": {"materials": 3000, "wealth": 1500},
    ...
    "shipyard": {
        ...
        "base_construction_cost": {"materials": 2500, "wealth": 1500},
    ...
    "weapons_factory": {
        ...
        "base_construction_cost": {"materials": 2500, "wealth": 1500, "manpower": 500},
        "base_construction_turns": 15,
        "base_effects": {},
    },
    ...
    "factory": {
        ...
        "base_construction_cost": {"materials": 1500, "wealth": 800},
        "base_construction_turns": 12,
        "base_effects": {},
    },
    "textile_mill": {
        ...
        "base_construction_cost": {"materials": 800, "wealth": 400},
        "base_construction_turns": 6,
        "base_effects": {},
    },
    "electronics_factory": {
        ...
        "base_construction_cost": {"materials": 1800, "wealth": 1200},
        "base_construction_turns": 12,
    ...
    "precision_workshop": {
        ...
        "base_construction_cost": {"materials": 1200, "wealth": 700},
    ...
    "advanced_refinery": {
        ...
        "base_construction_cost": {"materials": 1600, "wealth": 900},
    ...
    "fuel_depot": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 600, "wealth": 300},
    ...
    "biofuel_plant": {
        ...
        "base_construction_cost": {"materials": 1000, "wealth": 600},
    ...
    "chemical_plant": {
        ...
        "base_construction_cost": {"materials": 1400, "wealth": 800},
        "base_construction_turns": 10,
        "base_effects": {},
    },
    "fertilizer_plant": {
    ...
    "pharmaceutical_lab": {
        ...
        "base_construction_cost": {"materials": 1000, "wealth": 800},
        "base_construction_turns": 9,
    ...
    "medical_supply_depot": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 600, "wealth": 500},
    ...
    "research_institute": {
        ...
        "base_workers": 200,
        "base_inputs": {"wealth": 200, "energy": 100},
        "base_outputs": {"research": 100},
        "base_construction_cost": {"materials": 1200, "wealth": 1000},
        "base_construction_turns": 10,
    ...
    "irrigation_network": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 900, "wealth": 400},
        "base_construction_turns": 8,
        "base_effects": {"farming_bonus": 0.15},
    },
    "grain_silo": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 500, "wealth": 250},
        "base_construction_turns": 4,
        "base_effects": {"stability_recovery_bonus": 0.10},
    },
    ...
    "oil_well": {
        ...
        "base_construction_cost": {"materials": 1300, "wealth": 700},
        "base_construction_turns": 9,
        "base_effects": {},
    },
    "logging_camp": {
    ...
    "cement_plant": {
        ...
        "base_construction_cost": {"materials": 1100, "wealth": 600},
        "base_construction_turns": 8,
        "base_effects": {},
    },
    "infrastructure_bureau": {
        ...
        "base_workers": 150,
        "base_inputs": {"wealth": 150, "research": 50},
        "base_outputs": {},
        "base_construction_cost": {"materials": 1000, "wealth": 800},
        "base_construction_turns": 9,
    ...
    "bank": {
        ...
        "base_workers": 150,
        "base_inputs": {"wealth": 200},
        "base_outputs": {},
        "base_construction_cost": {"materials": 800, "wealth": 1000},
        "base_construction_turns": 6,
    ...
    "stock_exchange": {
        ...
        "base_workers": 200,
        "base_inputs": {"wealth": 300, "research": 50},
        "base_outputs": {},
        "base_construction_cost": {"materials": 1500, "wealth": 2000},
        "base_construction_turns": 12,
    ...
    "road_network": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 1200, "wealth": 500},
        "base_construction_turns": 9,
    ...
    "railway_station": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 2500, "wealth": 1200},
        "base_construction_turns": 15,
    ...
    "logistics_hub": {
        ...
        "base_workers": 175,
        "base_inputs": {"wealth": 150, "fuel": 80},
        "base_outputs": {},
        "base_construction_cost": {"materials": 1000, "wealth": 700},
        "base_construction_turns": 8,
    ...
    "bridge": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 1000, "wealth": 400},
        "base_construction_turns": 8,
    ...
    "train_depot": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 1500, "wealth": 700},
        "base_construction_turns": 10,
    ...
    "train_station": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 2000, "wealth": 1000},
        "base_construction_turns": 12,
    ...
    "airport": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 3000, "wealth": 1800},
    ...
    "radio_tower": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 700, "wealth": 400},
        "base_construction_turns": 5,
        "base_effects": {"stability_recovery_bonus": 0.10},
    },
    "telegraph_network": {
        ...
        "base_workers": 100,
        "base_inputs": {"wealth": 100, "energy": 80},
        "base_outputs": {},
        "base_construction_cost": {"materials": 800, "wealth": 600},
        "base_construction_turns": 6,
    ...
    "broadcasting_station": {
        ...
        "base_workers": 120,
        "base_inputs": {"energy": 150, "wealth": 100},
        "base_outputs": {},
        "base_construction_cost": {"materials": 1000, "wealth": 700},
    ...
    "tavern": {
        ...
        "base_workers": 60,
        "base_inputs": {"food": 100, "wealth": 60},
        "base_outputs": {},
        "base_construction_cost": {"materials": 300, "wealth": 200},
    ...
    "resort": {
        ...
        "base_workers": 250,
        "base_inputs": {"wealth": 200, "consumer_goods": 100, "fuel": 60},
        "base_outputs": {},
        "base_construction_cost": {"materials": 1200, "wealth": 1000},
        "base_construction_turns": 10,
    ...
    "clinic": {
        ...
        "base_workers": 100,
        "base_inputs": {"medicine": 50, "wealth": 80},
        "base_outputs": {},
        "base_construction_cost": {"materials": 700, "wealth": 500},
        "base_construction_turns": 6,
    ...
    "hospital": {
        ...
        "base_workers": 350,
        "base_inputs": {"medicine": 120, "energy": 100, "wealth": 150},
        "base_outputs": {},
        "base_construction_cost": {"materials": 2000, "wealth": 1500},
        "base_construction_turns": 14,
    ...
    "church": {
        ...
        "base_workers": 80,
        "base_inputs": {"wealth": 60},
        "base_outputs": {},
        "base_construction_cost": {"materials": 500, "wealth": 300},
        "base_construction_turns": 5,
    ...
    "madrasa": {
        ...
        "base_workers": 100,
        "base_inputs": {"wealth": 80, "research": 30},
        "base_outputs": {},
        "base_construction_cost": {"materials": 600, "wealth": 400},
        "base_construction_turns": 6,
    ...
    "solar_array": {
        ...
        "base_construction_cost": {"materials": 800, "wealth": 500},
        "base_construction_turns": 6,
        "base_effects": {},
    },
    "hydroelectric_dam": {
    ...
    "regulatory_office": {
        ...
        "base_inputs": {"wealth": 80},
        "base_outputs": {},
        "base_construction_cost": {"materials": 500, "wealth": 400},
        "base_construction_turns": 5,
    ...
    "standards_bureau": {
        ...
        "base_workers": 120,
        "base_inputs": {"wealth": 100, "research": 30},
        "base_outputs": {},
        "base_construction_cost": {"materials": 600, "wealth": 500},
        "base_construction_turns": 6,
    ...
    "inspector_general": {
        ...
        "base_inputs": {"wealth": 60},
        "base_outputs": {},
        "base_construction_cost": {"materials": 400, "wealth": 350},
        "base_construction_turns": 4,
    ...
    "audit_commission": {
        ...
        "base_outputs": {},
        "base_construction_cost": {"materials": 500, "wealth": 450},
        "base_construction_turns": 5,
    ...
    "civil_service_academy": {
        ...
        "base_workers": 120,
        "base_inputs": {"wealth": 100, "research": 40},
        "base_outputs": {},
        "base_construction_cost": {"materials": 700, "wealth": 600},
        "base_construction_turns": 7,
    ...
    "administrative_center": {
        ...
        "base_workers": 150,
        "base_inputs": {"wealth": 120},
        "base_outputs": {},
        "base_construction_cost": {"materials": 800, "wealth": 700},
        "base_construction_turns": 8,
    ...
    "public_school": {
        ...
        "base_inputs": {"wealth": 80},
        "base_outputs": {},
        "base_construction_cost": {"materials": 500, "wealth": 350},
        "base_construction_turns": 5,
    ...
    "social_services_office": {
        ...
        "base_workers": 100,
        "base_inputs": {"wealth": 100, "consumer_goods": 40},
        "base_outputs": {},
        "base_construction_cost": {"materials": 500, "wealth": 400},
        "base_construction_turns": 5,
    ...
    "public_housing": {
        ...
        "base_workers": 80,
        "base_inputs": {"materials": 80, "wealth": 60},
        "base_outputs": {},
        "base_construction_cost": {"materials": 600, "wealth": 300},
        "base_construction_turns": 5,
    ...
    "army_base": {
        ...
        "base_workers": 300,
        "base_inputs": {"wealth": 100, "military_goods": 50},
        "base_outputs": {},
        "base_construction_cost": {"materials": 1500, "wealth": 800, "manpower": 500},
        "base_construction_turns": 10,
        "base_effects": {},
    },
    "naval_base": {
        ...
        "base_workers": 300,
        "base_inputs": {"wealth": 130, "military_goods": 65, "fuel": 30},
        "base_outputs": {},
        "base_construction_cost": {"materials": 2000, "wealth": 1200, "manpower": 600},
        "base_construction_turns": 13,
        "base_effects": {},
    },
    "air_base": {
        ...
        "base_workers": 200,
        "base_inputs": {"wealth": 80, "military_goods": 40, "fuel": 120},
        "base_outputs": {},
        "base_construction_cost": {"materials": 800, "wealth": 600, "manpower": 300},
        "base_construction_turns": 6,
        "base_effects": {},
    },
    ...
    "military_academy": {
        ...
        "cost_scale": 1.80,
        "base_workers": 350,
        "base_inputs": {"wealth": 500, "research": 100, "consumer_goods": 150},
        "base_outputs": {},
        "base_construction_cost": {"materials": 5000, "wealth": 4000},
    ...
    "naval_war_college": {
        ...
        "cost_scale": 1.80,
        "base_workers": 350,
        "base_inputs": {"wealth": 500, "research": 100, "fuel": 150},
        "base_outputs": {},
        "base_construction_cost": {"materials": 5000, "wealth": 4000},
        "base_construction_turns": 24,
        "base_effects": {
    ...
    "air_force_academy": {
        ...
        "cost_scale": 1.80,
        "base_workers": 350,
        "base_inputs": {"wealth": 500, "research": 120, "fuel": 100, "components": 50},
        "base_outputs": {},
        "base_construction_cost": {"materials": 5000, "wealth": 4500},
